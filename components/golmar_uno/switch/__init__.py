...
open_door_switch_ns = golmar_uno_ns.class_("open_door_switch", switch.Switch)

CONFIG_SCHEMA = switch.switch_schema(open_door_switch_ns).extend(
    {
...
async def to_code(config):
    ...
    cg.add(hub.set_open_door_switch_(sw))
